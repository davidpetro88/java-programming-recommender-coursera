...
public class QuizWeek01 {
	...
	public void testQuiz2() {
		ArrayList<Movie> loadMoviesTotal = firstRatings.loadMovies("data/ratedmoviesfull.csv");
		String genre = "Comedy"; 
		Long runCountGenre = loadMoviesTotal.stream().filter(movie -> (movie.getGenres().contains(genre))).count();
	...
	public void testQuiz8(){
        ...
        assertEquals(maxRatings.getAsInt(), 314);
	...
	public void testQuiz10() {
        ...
        assertEquals(3143, movieSet.size());
	}
}